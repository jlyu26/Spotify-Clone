...
<script>
	...
	function setShuffle() {
		...
		if (shuffle) {
			...
			// shuffle has been deactivated, bo back to regular playlist
			currentIndex = currentPlaylist.indexOf(audioElement.currentlyPlaying.id);
		}

		console.log('[Current Playing]', currentPlaylist);
	...
	function setTrack(trackId, newPlaylist, play) {
		...
		if (newPlaylist != currentPlaylist) {
			...
			shufflePlaylist = currentPlaylist.slice();	// return a copy of currentPlaylist
			shuffleArray(shufflePlaylist);
		}
		...
		<div id="nowPlayingLeft">
			<div class="content">
				<span class="albumLink">
					<img  role="link" tabindex="0" src="https://i.ytimg.com/vi/rb8Y38eilRM/maxresdefault.jpg" class="albumArtwork">
				</span>
